...
if (a IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then a else null END))) AS a,
if (b IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then b else null END))) AS b,
if (c IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then c else null END))) AS c,
if (d IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then d else null END))) AS d,
if (e IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then e else null END))) AS e,
if (f IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then f else null END))) AS f,
if (g IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then g else null END))) AS g,
if (h IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
max(case when scantype = 'Analyse' then h else null END))) AS h,
if (i IS NULL,NULL,TIMESTAMPDIFF(SECOND,max(case when scantype = 'Log' then least(a,b,c,d,e,f,g,h,i) else null END),
