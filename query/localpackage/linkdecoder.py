...
def decode(s):
    ...
    if a == 0:
        ...
        return {
            "lightyears": float(a) * unit,
            "numerator": a,
            "denominator": "n/a",
            "denominatorStatus": "ok",
            "precisionStatus": "ok",
            "status": True,
        }
    ...
    if 1000 % b != 0:
        dc = "The denominator {} in ratio {}:{} is not a fraction of 1000".format(
            b, a, b
        )
    else:
        dc = "ok"
    ...
    if len(fraction) > 3:
        pc = "The result of division  ({}) for {}/{} should only have 3 decimal places".format(
            val, a, b
        )
    else:
        pc = "ok"
    ...
    res = {
        "lightyears": (float(a) / float(b)) * unit,
        "numerator": a,
        "denominator": b,
        "denominatorStatus": dc,
        "precisionStatus": pc,
        "status": status,
    }
    return res
...
"""
               __                               ___             __           
   ____ ____  / /_   _________  ____  _________/ (_)___  ____ _/ /____  _____
  / __ `/ _ \/ __/  / ___/ __ \/ __ \/ ___/ __  / / __ \/ __ `/ __/ _ \/ ___/
 / /_/ /  __/ /_   / /__/ /_/ / /_/ / /  / /_/ / / / / / /_/ / /_/  __(__  ) 
 \__, /\___/\__/   \___/\____/\____/_/   \__,_/_/_/ /_/\__,_/\__/\___/____/  
/____/                                                                       
...
"""
               __                __                 
   ____ ____  / /_   _________  / /_  ___  ________ 
  / __ `/ _ \/ __/  / ___/ __ \/ __ \/ _ \/ ___/ _ \
 / /_/ /  __/ /_   (__  ) /_/ / / / /  __/ /  /  __/
 \__, /\___/\__/  /____/ .___/_/ /_/\___/_/   \___/ 
/____/                /_/                           
...
"""
   __       _ __      __                  __     
  / /______(_) /___ _/ /____  _________ _/ /____ 
 / __/ ___/ / / __ `/ __/ _ \/ ___/ __ `/ __/ _ \
/ /_/ /  / / / /_/ / /_/  __/ /  / /_/ / /_/  __/
\__/_/  /_/_/\__,_/\__/\___/_/   \__,_/\__/\___/ 
...
def distance(sys1, sys2):
    return math.sqrt(
        math.pow((sys1[0] - sys2[0]), 2)
        + math.pow((sys1[1] - sys2[1]), 2)
        + math.pow((sys1[2] - sys2[2]), 2)
    )


"""
    ____                  __           __      __     
   / __ \___  _________ _/ /______  __/ /___ _/ /____ 
...
"""
  ...
  / ____/ /_  ___  _____/ /__   / ____/___  ____  / /__________  / /
 / /   / __ \/ _ \/ ___/ //_/  / /   / __ \/ __ \/ __/ ___/ __ \/ / 
/ /___/ / / /  __/ /__/ ,<    / /___/ /_/ / / / / /_/ /  / /_/ / /  
\____/_/ /_/\___/\___/_/|_|   \____/\____/_/ /_/\__/_/   \____/_/   
...
"""
   ______     __     ______     _ __      __                  __  _                ____                  ____ 
  / ____/__  / /_   /_  __/____(_) /___ _/ /____  _________ _/ /_(_)___  ____     / __ \___  _______  __/ / /_
 / / __/ _ \/ __/    / / / ___/ / / __ `/ __/ _ \/ ___/ __ `/ __/ / __ \/ __ \   / /_/ / _ \/ ___/ / / / / __/
/ /_/ /  __/ /_     / / / /  / / / /_/ / /_/  __/ /  / /_/ / /_/ / /_/ / / / /  / _, _/  __(__  ) /_/ / / /_  
\____/\___/\__/    /_/ /_/  /_/_/\__,_/\__/\___/_/   \__,_/\__/_/\____/_/ /_/  /_/ |_|\___/____/\__,_/_/\__/  
...
def get_trilateration_result(O, r1, r2, r3, res):
    ...
    res["trilateration"] = {
        "coords": [results[0].tolist(), results[1].tolist()],
        "spread": spread,
    }
    ...
    for i in candidates:
        ...
        try:
            ...
            distancePick = (
                pick.get("matches") == matchCount and pick.get("control") >= cd
            )
    ...
    res["Result"] = {
        "name": pick.get("name"),
        "error": pick.get("distance"),
        "control": pick.get("control"),
        "matches": pick.get("matches"),
        "result": restext,
        "logs": log,
    }
...
"""
   ______     __     ____  _      __                           ____                  ____ 
  / ____/__  / /_   / __ \(_)____/ /_____ _____  ________     / __ \___  _______  __/ / /_
 / / __/ _ \/ __/  / / / / / ___/ __/ __ `/ __ \/ ___/ _ \   / /_/ / _ \/ ___/ / / / / __/
/ /_/ /  __/ /_   / /_/ / (__  ) /_/ /_/ / / / / /__/  __/  / _, _/  __(__  ) /_/ / / /_  
\____/\___/\__/  /_____/_/____/\__/\__,_/_/ /_/\___/\___/  /_/ |_|\___/____/\__,_/_/\__/  
